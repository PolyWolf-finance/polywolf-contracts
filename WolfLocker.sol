...
// File: contracts/WolfLocker.sol

pragma solidity 0.6.12;


/**
 * @dev WolfLocker contract locks the liquidity (LP tokens) which are added by the dev
 *
 * The owner of WolfLocker will be transferred to the timelock once the contract deployed.
 *
 ...
 *
 * Website: https://polywolf.finance
 * Twitter: https://twitter.com/polywolf_fi
 */
contract WolfLocker is Ownable {
    ...
    function unlock(IBEP20 _token, address _recipient) public onlyOwner {
        require(_recipient != address(0), "WolfLocker::unlock: ZERO address.");
